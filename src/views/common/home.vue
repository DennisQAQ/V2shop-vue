<template>
  <div class="mod-home">
    <h3>项目介绍</h3>
    <ul>
      <li>v2shop management基于vue、element-ui构建开发，实现<a href="https://rainsofcastamere.com/admin" target="_blank">v2shop</a>后台管理前端功能</li>
    ...
    <h3>获取帮助</h3>
    <ul>
      <li>个人网站：<a href="https://rainsofcastamere.com/" target="_blank">https://rainsofcastamere.com/</a></li>
      <li>前端Git地址：<a href="https://github.com/DennisQAQ/V2shop-vue.git" target="_blank">https://github.com/DennisQAQ/V2shop-vue.git</a></li>
      <li>后台Git地址：<a href="https://github.com/DennisQAQ/V2shop.git" target="_blank">https://github.com/DennisQAQ/V2shop.git</a></li>
